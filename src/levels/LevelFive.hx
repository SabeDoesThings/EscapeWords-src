...
class LevelFive extends Level {
    ...
    public function new() {
        ...
        txt = new Text(font);
        txt.text = "Is my wife cheating on me?";
        ...
        block1 = new Block(821, 375, Res.letter_blocks.Y_block.toTile());
        this.addChild(block1);
        block2 = new Block(633, 625, Res.letter_blocks.E_block.toTile());
        this.addChild(block2);
        block3 = new Block(750, 492, Res.letter_blocks.S_block.toTile());
    ...
    public override function update(dt: Float) {
        ...
        if (this.allBlocksPlaced == true) {
            if (
                ...
                Timer.delay(
                    () -> {
                        Main.inst.setLevel(new LevelSix());
                        this.dispose();
                    },
                    Math.floor(1.5) * 1000
                );
