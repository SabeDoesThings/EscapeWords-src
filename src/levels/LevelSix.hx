...
class LevelSix extends Level {
    ...
    //sounds
    public static var whisperSound: Sound;
    ...
    public function new() {
        ...
        block1 = new Block(1192, 118, Res.letter_blocks.K_block.toTile());
        this.addChild(block1);
        block2 = new Block(255, 606, Res.letter_blocks.I_block.toTile());
        this.addChild(block2);
        block3 = new Block(717, 288, Res.letter_blocks.L_block.toTile());
        this.addChild(block3);
        block4 = new Block(1148, 472, Res.letter_blocks.L_block.toTile());
    ...
    public override function update(dt: Float) {
        ...
        if (this.allBlocksPlaced == true) {
            if (
                ...
                Timer.delay(
                    () -> {
                        Main.inst.setLevel(new LevelSeven());
                        this.dispose();
                    },
                    Math.floor(1.5) * 1000
                );
