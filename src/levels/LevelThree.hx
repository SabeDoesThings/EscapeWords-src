...
class LevelThree extends Level {
    ...
    public function new() {
        ...
        txt = new Text(font);
        txt.text = "What is used a lot in programming?";
        ...
        block1 = new Block(1192, 118, Res.letter_blocks.M_block.toTile());
        this.addChild(block1);
        block2 = new Block(255, 606, Res.letter_blocks.A_block.toTile());
        this.addChild(block2);
        block3 = new Block(717, 288, Res.letter_blocks.T_block.toTile());
        this.addChild(block3);
        block4 = new Block(1148, 472, Res.letter_blocks.H_block.toTile());
    ...
    public override function update(dt: Float) {
        ...
        if (this.allBlocksPlaced == true) {
            if (
                ...
                Timer.delay(
                    () -> {
                        Main.inst.setLevel(new LevelFour());
                        this.dispose();
                    },
                    Math.floor(1.5) * 1000
                );
